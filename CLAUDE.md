...
- [Road segment selection](.claude/ROAD_SELECTION.md) - **Click the road, not the worker** — corridor hover/select, "Road" popover (delete, swap worker ↔ donkey), fingerprint-based reselection across recalc
